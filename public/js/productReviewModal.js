...
productReviewTemplate += '<div class="review_before" >'
productReviewTemplate += '    <h2>리뷰쓰기</h2>'
productReviewTemplate += '    <h3>리뷰 쓸 상품을 선택해주세요.</h3>'
productReviewTemplate += '<div style="margin-bottom:24px">'
productReviewTemplate += '<input type="checkbox" class="required" required="required" id="rc">'
productReviewTemplate += '<label for="rc" class="rc"><span>전체선택</span></label>'
productReviewTemplate += '</div>'
productReviewTemplate += '<div class="detailBox">'
productReviewTemplate += '<input type="checkbox" class="required" required="required" class="rc">'
...
productReviewTemplate += '                 <button type="button" @click="">확인</button>'
productReviewTemplate += '                  </div>'
productReviewTemplate += '</div>'
